    ...
    public class Bestenlisten
    {
                                    ...
                                    if (!string.IsNullOrEmpty(items[0])) //Ist der DS gültig?
                                    {
                                        ...
                                        if (ok)
                                        {
                                            ...
                                            switch (items[2])
                                            {
                                                case "EasyMode":
                                                    {
                                                        spieler.Difficulty = new Easy();        //difficulty
                                                ...
                                                case "Medium":
                                                    {
                                                        spieler.Difficulty = new Medium();      //difficulty
                                                ...
                                                case "Hard":
                                                    {
                                                        spieler.Difficulty = new Hard();        //difficulty
        ...
        public bool CheckBest(Spieler player, out int platz)
        {
            ...
            switch (player.Difficulty.ToString())
            {
                ...
                default: { ok = false; break; } //Wenn weder EasyMode, Medium oder Hard.
            }//switch
        ...
        public bool InsertSorted(Spieler player)
        {
            ...
            if (CheckBest(player, out platzierung))
            {
                switch (player.Difficulty.ToString())
                {
                    ...
                    default: { ok = false; break; } //Wenn das Spieler-Objekt weder EasyMode, Medium oder Hard ist.
                }//switch(difficulty)
            }//if(CheckBest)
